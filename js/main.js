...
document.displayInitMessage = function() {
  document.getElementById("finalInfoText").innerHTML = " \
    Scrivi una frase in italiano e premi su <i>riocontralo!</i> per la sua \
    traduzione.";
    ...
    function onClickTranslate (event) {
      ...
      if (toBeTrasnslated === "") {
        ...
        if (document.mode == "supercazzolaro") {
          finalInfoText = "Hai tradotto usando il <span class='highlight-text'>supercazzolaro</span>. \
            Prova anche gli altri traduttori e scopri le loro abilità.";
        } else if (document.mode == "advancedSettings") { 
          finalInfoText = "Hai tradotto utilizzando le <span class='highlight-text'>impostanezio avanteza</span>. \
            Insoddisfatto? Scegli uno dei nostri fantastici traduttori."
        } else {
          finalInfoText = "Hai tradotto utilizzando le abilità del <span class='highlight-text'>" + document.mode + "</span>. \
            Insoddisfatto? Scegli il <span class='highlight-text'>supercazzolaro</span> per usare tutte le regole e tradurre tutte le parole!"
        }
